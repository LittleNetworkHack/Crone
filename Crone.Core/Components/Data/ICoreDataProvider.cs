...
public interface ICoreDataProvider
{
    ...
    string BuildConnection(string server, int port, string catalog, string username, string password);
    ...
    where TReader : DbDataReader
{
    ...
    TConnection CreateConnection(string server, int port, string catalog, string username, string password);
